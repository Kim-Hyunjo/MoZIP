...
const Apply2 = ({history}:any) => {
    ...
    const renderSubmit = () =>{
        if(agreement){
            return(
                <Link to='/list/:subject/:circle_id/detail'><button id="button4" type="submit">제출</button></Link>
            )
        }
        return(
            <button id="button4" type="submit" disabled >제출</button>
        )
    }
        ...
        <div>
            ...
            <div>
                ...
                <form action="">
                    <div className ="apply_questions">
                        ...
                        <div className ="question_box">
                            ...
                            <div> 
                                <div className = "applyCheckbox"><input type="checkbox" name="Python" value="Python"/>Python</div>
                                <div className = "applyCheckbox"><input type="checkbox" name="C" value="C"/>C</div>
                                <div className = "applyCheckbox"><input type="checkbox" name="Java" value="Java"/>Java</div>
                            </div>
                        </div>
                        ...
                        <div className ="question_box">
                            ...
                            <div>    
                                ...
                                <div><input type="checkbox" checked={date1} onChange={checkDateChange1} name="first" value="2020년 7월 18일 수요일"/><strong>2020년 7월 18일 수요일</strong><input type="select" maxLength={2} /> 시 ~<input type="select"maxLength={2} /> 시</div>
                                <div><input type="checkbox" checked={date2} onChange={checkDateChange2} name="second" value="2020년 7월 19일 목요일"/><strong>2020년 7월 19일 목요일</strong><input type="select"maxLength={2} /> 시 ~<input type="select"maxLength={2} /> 시</div>
                                <div><input type="checkbox" checked={date3} onChange={checkDateChange3} name="third" value="2020년 7월 20일 금요일"/><strong>2020년 7월 20일 금요일</strong><input type="select"maxLength={2}/> 시 ~<input type="select"maxLength={2} /> 시</div>
                ...
                <div className="apply2Buttons">
                    <Link to ="/list/:subject/:circle_id/apply"><button id="button1" type="button">이전</button></Link>
