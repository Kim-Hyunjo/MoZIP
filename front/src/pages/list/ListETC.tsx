...
const 봉사 = [{name: "기타", introduction:"국내 최초 4차 산업혁명동아리"},{name: "Tave", introduction:"국내 최초 4차 산업혁명동아리"},{name: "Tave", introduction:"국내 최초 4차 산업혁명동아리"},{name: "Tave", introduction:"국내 최초 4차 산업혁명동아리"}
       ...
       <>
        ...
        <div className="club_list">
            <ul id = "horizontal_club_list">
                {봉사.map((item)=> {
                    return(
                        <li style={{marginRight:'10px'}}><Link to="/list/etc"><h3>{item.name}</h3><p>{item.introduction}</p></Link></li>
                    )
                })}
            </ul>
        </div>
