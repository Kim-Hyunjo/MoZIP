         ...
         <div className = "circleMembersEdit">
             ...
             <div>
                <div className="role">
                 ...
                 <div className="user_namecard_edit">
                     <div className="user_name">최우영</div>
                     <div className="user_role">회장</div>
             ...
             <div>
                <div className="role">
                 ...
                 <div className="user_namecard_edit">
                     <div className="user_name">최우영</div>
                    <button id="button_x" type="button">x</button>
                     <div className="submaster_role">부회장</div>
             ...
             <div>
                <div className="role">
                 ...
                 <div className="user_namecard_edit">
                     <div className="user_name">최우영</div>
                    <button id="button_x" type="button">x</button>
                     <div className="submaster_role">기술</div>
                     <div className="subClubImage">
                        <img src="http://placehold.it/120x120" />
                    </div>
                </div> 
